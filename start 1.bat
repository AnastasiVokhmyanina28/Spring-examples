...
javac -d src/main/classes -classpath src/main/resources/libs/spring-context-5.3.18.jar;src/main/resources/libs/aspectjlib-1.6.2.jar;src/main/resources/libs/spring-beans-5.3.18.jar;src/main/resources/libs/spring-core-5.3.18.jar  -sourcepath src/main/java src/main/java/org/example/K2/*.java
